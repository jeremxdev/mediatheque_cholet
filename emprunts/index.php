...
$emprunts = $pdo->query("
    SELECT e.*, a.nomadh, a.prenomadh, ex.Id_Exemplaire, ex.etat, l.titre, l.isbn
    FROM Emprunt e
            ...
            <tbody>
                ...
                <?php foreach ($emprunts as $emprunt): ?>
                    <tr>
                        ...
                        <!-- Numero d'exemplaire + badge etat -->
                        <td>
                            #<?php echo $emprunt['Id_Exemplaire']; ?>
                            <span class="badge badge-blue"><?php echo htmlspecialchars($emprunt['etat'] ?? '-'); ?></span>
                        </td>
                        <!-- Nom complet de l'adherent -->
                        <td><?php echo htmlspecialchars($emprunt['prenomadh'] . ' ' . $emprunt['nomadh']); ?></td>
                        <!-- Dates formatees jj/mm/aaaa -->
                        <td><?php echo $emprunt['dateemprrunt'] ? date('d/m/Y', strtotime($emprunt['dateemprrunt'])) : '-'; ?></td>
                        <td><?php echo $emprunt['dateretour'] ? date('d/m/Y', strtotime($emprunt['dateretour'])) : '-'; ?></td>
                        <td>
                            <div class="btn-group">
