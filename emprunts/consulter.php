...
$stmt = $pdo->prepare("
    SELECT e.*, a.nomadh, a.prenomadh, a.mailadh, a.telephoneadh, ex.Id_Exemplaire, ex.etat, l.titre, l.isbn
    FROM Emprunt e
...
<div class="detail-container">
    ...
    <div class="detail-body">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">#<?php echo $emprunt['Id_Exemplaire']; ?> (<?php echo htmlspecialchars($emprunt['etat'] ?? '-'); ?>)</span>
        </div>
        <div class="detail-row">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value"><?php echo $emprunt['dateretour'] ? date('d/m/Y', strtotime($emprunt['dateretour'])) : '-'; ?></span>
        </div>
    </div>
</div>
