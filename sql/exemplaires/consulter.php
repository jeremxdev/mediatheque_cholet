...
<div class="detail-container">
    <div class="detail-header">
        <h2>Exemplaire <?php echo htmlspecialchars($exemplaire['code_exemplaire'] ?? ('#' . $exemplaire['Id_Exemplaire'])); ?></h2>
        <div class="btn-group">
    ...
    <div class="detail-body">
        <div class="detail-row">
            <span class="detail-label">Code exemplaire</span>
            <!-- Code construit a partir de la classification Dewey et du rang d'arrivee -->
            <span class="detail-value"><strong><?php echo htmlspecialchars($exemplaire['code_exemplaire'] ?? ('#' . $exemplaire['Id_Exemplaire'])); ?></strong></span>
        </div>
        <div class="detail-row">
        ...
        <div class="detail-row">
            <span class="detail-label">Disponibilite</span>
            <!-- Disponible si aucun emprunt en cours sur cet exemplaire -->
            <span class="detail-value">
                <?php if (exemplaire_est_disponible($pdo, $exemplaire['Id_Exemplaire'])): ?>
