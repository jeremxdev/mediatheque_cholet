...
// Sous-requetes : nombre d'exemplaires (Posseder) et disponibilite numerique.
$livres = $pdo->query("
    SELECT l.*, d.libelledewey,
    (SELECT COUNT(*) FROM Posseder p WHERE p.Id_Livre = l.Id_Livre) AS nb_exemplaires,
    (SELECT COUNT(*) FROM livre_num ln WHERE ln.Id_Livre = l.Id_Livre) AS a_version_num
    FROM Livre l
            ...
            <tbody>
                ...
                <?php foreach ($livres as $livre): ?>
                    <tr>
                        ...
                        <!-- Nombre d'exemplaires papier associes -->
                        <td><?php echo $livre['nb_exemplaires']; ?></td>
