        ...
        <table>
            ...
            <tbody>
                ...
                <?php foreach ($adherents as $adherent): ?>
                    <tr>
                        <!-- Code unique (rang d'inscription) -->
                        <td><strong><?php echo htmlspecialchars($adherent['code_adherent'] ?? ('AD' . str_pad((string)$adherent['Id_Adherent'], 4, '0', STR_PAD_LEFT))); ?></strong></td>
                        ...
                        <!-- Date de naissance formatee + badge Majeur / Mineur -->
                        <td>
                        ...
                        <!-- Date d'adhesion -->
                        <td><?php echo $adherent['dateadhesion'] ? date('d/m/Y', strtotime($adherent['dateadhesion'])) : '-'; ?></td>
                        <td>
