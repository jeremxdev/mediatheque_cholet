...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $pdo->prepare("UPDATE Livre SET titre=?, datesortie=?, isbn=?, dateachat=?, codewey=? WHERE Id_Livre=?");
        $stmt->execute([$titre, $datesortie ?: null, $isbn, $dateachat ?: null, $codewey, $id]);
